...
if [[ ${App_display_name_default} != ${App_display_name} ]]; then
	echo -e "\033[35m* App_display_name默认值 = ${App_display_name_default}\033[0m"
	...
	echo -e "\033[35m* App_display_name改变后 = ${Project_display_name}\033[0m"
else
	Project_display_name=$App_display_name_default
fi
if [[ ${App_version_default} != ${App_version} ]]; then
	echo -e "\033[35m* App_version默认值 = ${App_version_default}\033[0m"
	...
	echo -e "\033[35m* App_version改变后 = ${Version_result}\033[0m"
else
	Project_version=$App_version_default
fi

if [[ ${App_build_default} != ${current_date} ]]; then
	echo -e "\033[35m* App_build_default默认值 = ${App_build_default}\033[0m"
	...
	echo -e "\033[35m* App_build改变后 = ${Project_build}\033[0m"
else
